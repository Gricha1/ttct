...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--use-lora", "type": lambda x: bool(strtobool(x)), "default":True, "help": "wheather to use lora"},
        {"name": "--is-finetune", "type": lambda x: bool(strtobool(x)), "default":True, "help": "wheather finetune encode model"},
        {"name": "--use_pretrained_encoders", "type": lambda x: bool(strtobool(x)), "default":False, "help": "wheather finetune encode model"},
